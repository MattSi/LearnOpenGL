...
int stencil_testing(int argc, char* argv[]) {
    glfwInit();
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Project 19, Stencil Testing", NULL, NULL);
    if (window == NULL)
    {
   ...
   // -------------
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shaderSingleColor.setMat4("projection", proj);
        ...
        // 2nd. render pass: now draw slightly scaled version of the objects, this time disabling stencil drawing.
