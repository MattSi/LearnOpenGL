...
int diffuse(int argc, char* argv[]) {
    glfwInit();
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Project 14, LightMapping - diffuse", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader lightingShader("lighting_maps_diffuse.vs", "lighting_maps_diffuse.fs");
