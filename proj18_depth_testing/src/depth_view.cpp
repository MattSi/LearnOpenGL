...
int depth_view(int argc, char* argv[]) {
    glfwInit();
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Project 18, Depth View", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader shader("depth_view.vs", "depth_view.fs");
