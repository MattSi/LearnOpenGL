...
int blinn_phong(int argc, char* argv[]) {
    glfwInit();
    ...
    Shader shader("blinnphong.vs", "blinnphong.fs");
  ...
  // ------------------------------------------------------------------
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 proj = glm::perspective(glm::radians(camera.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 8.0f);
