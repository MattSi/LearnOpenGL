...
int sm_depth(int argc, char* argv[]) {
    glfwInit();
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Project 26, Blinn Phong light model", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader simpleDepthShader("sm_depth.vs", "sm_depth.fs");
